...
class SegHandler:
    ...
    def classify_segment(self, segment, x1, x2, rw_angle1):
        ...
        # reject empty lines used for triggers etc
        ...
        # borders with different light levels or textures
        self.clip_portal_walls(x1, x2)